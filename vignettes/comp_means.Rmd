...
The `comp_means()` function in Pmisc provides a streamlined way to perform statistical comparisons across multiple features between groups. It automatically handles:

- Multiple statistical tests (t-test, Wilcoxon, ANOVA)
...
This vignette demonstrates the function using the classic `iris` dataset.
...
## Comparing All Three Species

Now let's compare across all three species using ANOVA:
...
All four features show highly significant differences across the three species.
