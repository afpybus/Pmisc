...
knitr::opts_chunk$set(
    ...
    fig.width = 7,
    fig.height = 5,
    fig.path = "figures/survival_analysis-",
    dev = "png",
    warning = FALSE,
    message = FALSE
)
...
This dataset includes `r nrow(lung)` patients with variables including:
- **time**: Survival time in days
- **status**: Censoring status (1=censored, 2=dead)
- **age**, **sex**, **ph.ecog**, **ph.karno**, etc.: Clinical and demographic variables
...
```{r gene_os_scatter, warning=FALSE, message=FALSE}
gene_OS_scatter(
    df = lung_prep,
    gene = "age"
) +
