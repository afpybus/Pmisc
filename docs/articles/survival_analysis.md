...
function tests multiple features simultaneously for association with
survival:
...
function creates Kaplan-Meier curves for categorical or continuous
variables:
...
function creates scatter plots showing the relationship between a
...
1.  **Batch testing** with
    [`coxph_all()`](https://afpybus.github.io/Pmisc/reference/coxph_all.md) -
    Test many features at once
...
- [`coxph_all()`](https://afpybus.github.io/Pmisc/reference/coxph_all.md):
  Cox proportional hazards for multiple features
- [`survival_volcano()`](https://afpybus.github.io/Pmisc/reference/survival_volcano.md):
  Volcano plot for survival results
- [`KM_categorical()`](https://afpybus.github.io/Pmisc/reference/KM_categorical.md):
  Kaplan-Meier survival curves
- [`gene_OS_scatter()`](https://afpybus.github.io/Pmisc/reference/gene_OS_scatter.md):
